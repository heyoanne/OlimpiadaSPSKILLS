...
function showFormForAtendimento(element) {
    ...
    document.getElementById('tipoAtendimentoSelecionado').value = tipoAtendimentoSelecionado;
}

function enviarFormulario() {
    var tipoAtendimento = document.getElementById('tipoAtendimentoSelecionado').value;
    ...
    if (tipoAtendimento) {
        ...
        if (tipoAtendimentoSelecionado === 'Preferencial') {
            ...
            if (tipoAtendimento === 'AAPM' || tipoAtendimento === 'Negociacoes' || tipoAtendimento === 'Boletos') {
                letraSecundaria = 'F';
            } else if (
                tipoAtendimento === 'Informacao' || tipoAtendimento === 'Cancelamento' ||
                tipoAtendimento === 'Entrega' || tipoAtendimento === 'Tpagas - Matriculas' ||
                tipoAtendimento === 'Gratuitas - Matriculas ' || tipoAtendimento === 'Online - Matriculas '
            ) {
                letraSecundaria = 'C';
        ...
        localStorage.setItem(senhaGerada, JSON.stringify({ nome: nomeCompleto, senha: senhaGerada })); 
...
function showFormForMPag() {
    document.getElementById('matriculaOptions').style.display = 'none';
    document.getElementById('formForFormulario').style.display = 'block';
    document.getElementById('tipoAtendimentoSelecionado').value = 'Tpagas - Matriculas';
}

function showFormForMGat() {
    document.getElementById('matriculaOptions').style.display = 'none';
    document.getElementById('formForFormulario').style.display = 'block';
    document.getElementById('tipoAtendimentoSelecionado').value = 'Gratuitas - Matriculas ';
}

function showFormForMOn() {
    document.getElementById('matriculaOptions').style.display = 'none';
    document.getElementById('formForFormulario').style.display = 'block';
    document.getElementById('tipoAtendimentoSelecionado').value = 'Online - Matriculas ';
}
...
function showFormForCCm() {
    ...
    document.getElementById('formForDocumentacao').style.display = 'none';
    document.getElementById('formForFormulario').style.display = 'block';
    document.getElementById('tipoAtendimentoSelecionado').value = 'Rápido - Certificado comum';
}
...
function showFormForCSg() {
    ...
    document.getElementById('formForDocumentacao').style.display = 'none';
    document.getElementById('formForFormulario').style.display = 'block';
    document.getElementById('tipoAtendimentoSelecionado').value = 'SGSET - Certificados';
}
